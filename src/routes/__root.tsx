  ...
  head: () => ({
    meta: [
      ...
      { title: "Inner Architecture Diagnostic™ | FutureProofCEOs" },
      {
        name: "description",
        content:
          "A research-grade diagnostic for CEOs and organizational leaders. Measure your Purpose, Resilience and Legacy architecture — with a Growth Readiness Index modifier in 12 minutes.",
      },
      ...
      { name: "twitter:description", content: "A research-grade diagnostic for CEOs and organizational leaders. Measure your Purpose, Resilience and Legacy architecture — with a Growth Readiness Index modifier in 12 minutes." },
